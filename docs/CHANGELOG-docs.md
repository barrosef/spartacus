...
- **Backoffice:** renomeada seção "Calendário" para "Calendário & Agenda" com nota de domínio transversal (ADR-05). Renomeada seção "Relatórios" para "Dashboards & Inteligência (V2)" com nota explicando a decisão anterior revisada.
...
- **Novo:** seção "🗂️ MVP vs V2" com tabela de domínios incluídos e excluídos, referenciando ADR-07.
...
- **Seção 11 (nova):** Fluxo de Proxy Access no App — entrada em modo proxy, indicador visual permanente, saída do modo proxy, escopo de visibilidade. Referencia ADR-04.

---

## Arquivos Criados

### `docs/adr/ADR-04-Proxy-Access.md`
...
### `docs/adr/ADR-05-Dominio-Calendario.md`
...
### `docs/adr/ADR-06-Mural-Comunicados.md`
...
| README mencionava posts de alunos na Timeline | Removido — incompatível com ADR-06 (somente staff posta) |
| README não mencionava `actingAs` em `presencas` | Adicionado — campo fundamental para auditoria de proxy access (ADR-04) |
